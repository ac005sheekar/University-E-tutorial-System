<?php
 include 'header.php';
 ?>
<br><b>Uttara Univerity is providing you<br>
The Priceless International Standard Tutorials<br> 
for<br> The Engineering Courses...</b><br>
<br><br><br>
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
	  ...
	  <a href="csenet.php">Computer Networks</a>
