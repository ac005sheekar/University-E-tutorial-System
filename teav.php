...
<h1><b>Teacher Information View</b></h1>
<?php
	...
	//echo "Connected successfully\n";
		...
		echo"<table><tr><th>Teacher_ID</th><th>Username</th><th>Password</th><th>Edit</th><th>Delete</th><th>Print</th></tr>";
...
// UPDATE CODE STARTS FROM HERE
				if(isset($_GET[$row['id']])){
					...
					if(isset($_POST['submit'])){
						...
						$ssql = "UPDATE teacher1 SET id='$id', username='$username', password='$password'
						WHERE id=".$row['id']."";
				...
				if(isset($_GET['delete'.$row['id']])){
					$delete = "DELETE FROM teacher1 WHERE id=".$row['id']."";
