...
<h1><b>Admin Information View</b></h1>
<?php
	...
	//echo "Connected successfully\n";
		...
		echo"<table><tr><th>Admin_ID</th><th>Username</th><th>Password</th><th>Edit</th><th>Delete</th><th>Print</th></tr>";
...
// UPDATE CODE STARTS FROM HERE
				if(isset($_GET[$row['id']])){
					...
					echo "Admin_ID: <input type='text' name='id' value=".$row['id'].">";
					echo "</br></br>";
					...
					if(isset($_POST['submit'])){
						...
						$ssql = "UPDATE admin1 SET id='$id', username='$username', password='$password'
						WHERE id=".$row['id']."";
				...
				if(isset($_GET['delete'.$row['id']])){
					$delete = "DELETE FROM admin1 WHERE id=".$row['id']."";
