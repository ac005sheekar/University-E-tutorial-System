...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="eeeca1.php">Circuit Analysis I</a>
	  <a href="eeeca2.php">Circuit Analysis II</a>
...
<h2>Welcome to Computer Science</h2><br><br>
<h3>Structured Programming Languages</h3><br><br>

<?php
 include 'slidecse.php';
 ?>
...
<body class="saidur">
	...
	<h3>Programming in C</h3><br> 
	Chapters:<br><br>
	<a href="cseprog1.php">1. Basic</a><br><br>
	<a href="cseprog2.php">2. Data types, Variables, Input/Output</a><br><br>
	<a href="cseprog3.php">3. Conditions and Loops</a><br><br>
	<a href="cseprog4.php">4. Functions</a><br><br>
	<a href="cseprog5.php">5. Array and Strings</a><br><br>
	<a href="cseprog6.php">6. Pointers</a><br><br><br>
	
	Programming in C++<br> 
	Chapters:<br><br>
	<a href="cseprog7.php">7. Basic</a><br><br>
	<a href="cseprog8.php">8. Input/Output</a><br><br>
	<a href="cseprog9.php">9. Conditions and Loops</a><br><br>
	<a href="cseprog10.php">10. Functions</a><br><br>
	<a href="cseprog11.php">11. Array and Strings</a><br><br>
	<a href="cseprog12.php">12. Pointers</a><br><br>
	<a href="cseprog13.php">13. OOP</a><br><br><br>
